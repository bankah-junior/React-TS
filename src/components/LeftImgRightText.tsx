...
const LeftImgRightText = ({ image, text1, text2 }: Props) => {
  return (
    <div className="flex flex-col w-full md:flex-row slide-left">
      <div className="md:w-2/5 md:h-[99vh]">
        <img src={image} alt="" className='w-full h-fullw-full md:h-full h-[470px] scale-in-center' />
      </div>
      <div className="relative flex items-center justify-center pt-2 md:pt-0 md:w-3/5">
        <h2 className='text-[#ec5755] font-bold text-2xl text-center md:text-6xl flip-in-ver-left'>{text1} <br /> {text2}</h2>
        <div className="absolute space-x-4 md:space-x-14 md:pb-2 -bottom-16 md:bottom-0 md:left-[40%] flex text-white">
